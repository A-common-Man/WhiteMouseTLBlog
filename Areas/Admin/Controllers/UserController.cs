...
namespace WhiteMouseTLBlog.Areas.Admin.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        /// <summary>
        /// https://localhost:7042/admin/user/index
        /// </summary>
        /// <returns></returns>
        ...
        public async Task<IActionResult> ResetPassword(string id)
        {
            ...
            {
                _notyfication.Error("User does not exists");
                return View();
            }
        ...
        public async Task<IActionResult> ResetPassword(ResetPasswordVM vm)
        {
            ...
            if (existingUser == null)
            {
                _notyfication.Error("User does not exist");
                return View(vm);
            }
            ...
            if (result.Succeeded)
            {
                _notyfication.Success("Password reset successful");
        ...
        /// <summary>
        /// https://localhost:7042/login,输入网址会返回一个Login页面，这个页面有一个新的对象LoginVM与Login页面绑定
        /// </summary>
        /// <returns></returns>
        [HttpGet("Login")]
        ...
        public async Task<IActionResult> Login(LoginVM vm)
        {
            ...
            _notyfication.Success("Login Successfull");
            return RedirectToAction("Index", "Post", new { area = "Admin" });
        }
